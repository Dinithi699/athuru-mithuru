  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-900 via-teal-700 to-teal-500 flex items-center justify-center">
      <div className="text-center text-white">
        ...
        <h1 className="text-5xl font-bold mb-8">සිංහල ග්‍රහලෝකය</h1>
        <p className="text-2xl mb-12">සිංහල භාෂා ක්‍රීඩා මෙහි නිර්මාණය වනු ඇත</p>
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-8 max-w-md mx-auto">
          ...
          <p className="text-lg mb-6">සිංහල ක්‍රීඩාව ඉදිරියේදී මෙහි එකතු කරනු ඇත</p>
